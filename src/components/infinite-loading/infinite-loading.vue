<template>
  <div class="om-infinite-loading-container">
    <div v-show="isLoading">
      <slot name="spinner">
        <component :is="spinnerView"></component>
      </slot>
    </div>
    <div class="om-infinite-status-prompt" v-show="isNoResults">
      <slot name="no-results">No results :(</slot>
    </div>
    <div class="om-infinite-status-prompt" v-show="isNoMore">
...
<span class="om-loading-bubbles">
  ...
  CIRCLES: {
    template: `<span class="om-loading-circles">
  ...
  DEFAULT: {
    template: '<i class="om-loading-default"></i>'
  },
  SPIRAL: {
    template: '<i class="om-loading-spiral"></i>'
  },
  WAVEDOTS: {
    template: `<span class="om-loading-wave-dots">
...
const WARNINGS = {
  STATE_CHANGER: [
    ...
    '\ntemplate:',
    '<om-infinite-loading @infinite="infiniteHandler"></om-infinite-loading>',
    `
   script:
    ...

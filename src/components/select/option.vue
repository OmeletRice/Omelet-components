<template>
  <li
    ...
    class="om-select-dropdown__item"
    v-show="visible"
    :class="{
...
<script type="text/babel">
  ...
  export default {
    ...
    watch: {
      currentLabel() {
        if (!this.created && !this.parent.remote) this.dispatch('OmSelect', 'setSelected');
      },
      value() {
        if (!this.created && !this.parent.remote) this.dispatch('OmSelect', 'setSelected');
      }
    ...
    methods: {
      ...
      selectOptionClick() {
        if (this.disabled !== true && this.groupDisabled !== true) {
          this.dispatch('OmSelect', 'handleOptionClick', this);
        }
      },
    ...
    beforeDestroy() {
      this.dispatch('OmSelect', 'onOptionDestroy', this);
    }
  };
</script>
